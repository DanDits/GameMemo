...
/**
 * This activity is used to select teams for a new Game. Players
 ...
 *
 */
public class GamePlayerSelectionActivity extends FragmentActivity implements ChoosePlayerDialogListener {
	...
	public static final String EXTRA_TEAM_MAX_PLAYERS = "dan.dit.gameMemo.EXTRA_TEAM_MAX_PLAYERS"; // if not given default 10
	public static final String EXTRA_PLAYER_NAMES = "dan.dit.gameMemo.EXTRA_PLAYER_NAMES"; // not required, to give suggestions for the slots, if result = ok these contains names
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.team_selection);
