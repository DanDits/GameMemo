...
public class TichuGameDetailFragment extends GameDetailFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mInputContainer = (ViewGroup) getView().findViewById(R.id.tichu_input_container);
	...
	private void initListeners() {
		...
		OnLongClickListener exchangePlayerListener = new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
		        ...
		        DialogFragment dialog = ChoosePlayerDialogFragment.newInstance(playerId, null, false, false);
