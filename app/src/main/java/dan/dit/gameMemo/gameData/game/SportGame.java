...
public abstract class SportGame extends Game {
    ...
    public static List<String> getLocations(int gameKey) {
        // game key parameter ignored since we do not save locations in combination with a game, there will never be too many locations so this is fine
        if (ALL_LOCATIONS == null) {
            return Collections.emptyList();
        }
        List<String> result = new ArrayList<String>(ALL_LOCATIONS);
